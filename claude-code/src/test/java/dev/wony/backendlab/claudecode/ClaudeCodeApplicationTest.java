package dev.wony.backendlab.claudecode;

import dev.wony.backendlab.claudecode.controller.HomeController;
...
@SpringBootTest
@DisplayName("ClaudeCodeApplication 통합 테스트")
class ClaudeCodeApplicationTest {
